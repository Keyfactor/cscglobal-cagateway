...
# Getting Started
## Prerequsites
To begin, you must have the CA Gateway Service 20.0.9 and Keyfactor Command 8.7.0.0 installed and operational before attempting to configure the CSC Global plugin. Follow the installation instructions
[here]().
